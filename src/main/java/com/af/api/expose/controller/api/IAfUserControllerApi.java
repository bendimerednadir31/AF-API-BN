...
public interface IAfUserControllerApi {
    ...
    public ResponseEntity<AuthenticationResponse> processAfUserRegistration(RegisterRequest request);
    ...
    public ResponseEntity<UserDetailsResponse> getAfUserById(int id);
}